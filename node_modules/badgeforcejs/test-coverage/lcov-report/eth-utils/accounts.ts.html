...
<html lang="en">
<head>
    <title>Code coverage report for eth-utils/accounts.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">All files</a> / <a href="index.html">eth-utils</a> accounts.ts
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1x</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import * as Wallet from 'ethereumjs-wallet';
...
<span class="cstat-no" title="statement not covered" >      throw new Error('Unable to import account');</span>
    }
  }
  async importAccountJSON(input, password) {
    try {
      ...
      <span class="missing-if-branch" title="else path not taken" >E</span>if (!wallet) {
