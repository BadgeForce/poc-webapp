...
<html lang="en">
<head>
    <title>Code coverage report for src/badgeforcetoken/badgeforcetoken-api.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">src/badgeforcetoken</a> badgeforcetoken-api.ts
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1x</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import {Contract, ContractConfig} from '../contract';
 ...
 */
export const getTokenAddress = <span class="fstat-no" title="function not covered" >(</span>web3Provider, artifacts) =&gt; {
    const Token = <span class="cstat-no" title="statement not covered" >contract(artifacts);</span>
<span class="cstat-no" title="statement not covered" >    Token.setProvider(web3Provider);</span>
<span class="cstat-no" title="statement not covered" >    return Token.deployed()</span>
    .then(<span class="fstat-no" title="function not covered" >(</span>instance) =&gt; {
<span class="cstat-no" title="statement not covered" >        return instance.address;</span>
    });
};
&nbsp;
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="https://istanbul.js.org/" target="_blank">istanbul</a> at Tue Jan 23 2018 23:44:08 GMT-0500 (EST)
</div>
</div>
